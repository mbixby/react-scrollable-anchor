...
var Manager = function Manager() {
  ...
  this.addAnchor = function (id, component, customHashUpdater) {
    ...
    _this.anchors[id] = {
      component: component,
      customHashUpdater: customHashUpdater
    };
  };
  ...
  this.handleScroll = function () {
    ...
    if (bestAnchorId && (0, _hash.getHash)() !== bestAnchorId) {
      _this.forcedHash = true;
      if (_this.anchors[bestAnchorId].customHashUpdater) {
        _this.anchors[bestAnchorId].customHashUpdater(bestAnchorId);
      } else {
