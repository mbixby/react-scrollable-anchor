...
var Manager = function Manager() {
  ...
  this.addAnchor = function (id, component, customHistoryUpdater) {
    ...
    _this.anchors[id] = {
      component: component,
      customHistoryUpdater: customHistoryUpdater
    };

    console.log('add anchor', _this.anchors[id]);
  };
  ...
  this.handleScroll = function () {
    ...
    if (bestAnchorId && (0, _hash.getHash)() !== bestAnchorId) {
      _this.forcedHash = true;
      if (_this.anchors[bestAnchorId].customHistoryUpdater) {
        _this.anchors[bestAnchorId].customHistoryUpdater(bestAnchorId);
      } else {
  ...
  this.goToSection = function (id) {
    var element = _this.anchors[id] && _this.anchors[id].component;
    console.log('go to section', element, id, _this.anchors[id]);
    if (element) {
